...
public final class KeyDrawParams {
    ...
    public void updateParams(final int keyWidth, final int keyHeight, @Nullable final KeyVisualAttributes attr) {
        ...
        final float textScale = currentSettings != null ? currentSettings.mKeyboardTextScale : 1.0f;

        mLetterSize = (int)(textScale * selectTextSizeFromDimensionOrRatio(keyHeight,
                attr.mLetterSize, attr.mLetterRatio, mLetterSize));
        mLabelSize = (int)(textScale * selectTextSizeFromDimensionOrRatio(keyHeight,
                attr.mLabelSize, attr.mLabelRatio, mLabelSize));
        mLargeLetterSize = (int)(textScale * selectTextSize(keyHeight, attr.mLargeLetterRatio, mLargeLetterSize));
        mHintLetterSize = (int)(textScale * selectTextSize(keyHeight, attr.mHintLetterRatio, mHintLetterSize));
        mShiftedLetterHintSize = (int)(textScale * selectTextSize(keyHeight,
                attr.mShiftedLetterHintRatio, mShiftedLetterHintSize));
        mHintLabelSize = (int)(textScale * selectTextSize(keyHeight, attr.mHintLabelRatio, mHintLabelSize));
        mPreviewTextSize = (int)(textScale * selectTextSize(keyWidth, attr.mPreviewTextRatio, mPreviewTextSize));
