...
public final class Settings implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String PREF_AVOID_ACCENT_ERROR = "pref_avoid_accent_error";
    public static final String PREF_SMART_BACKSPACE_DELETE_TONE = "pref_smart_backspace_delete_tone";
    ...
    public static float readKeyboardWidthScale(final SharedPreferences prefs,
            final float defaultValue) {
        final float percentage = prefs.getFloat(
                DebugSettings.PREF_KEYBOARD_WIDTH_SCALE, UNDEFINED_PREFERENCE_VALUE_FLOAT);
        return (percentage != UNDEFINED_PREFERENCE_VALUE_FLOAT) ? percentage : defaultValue;
    }

    public static float readKeyboardTextScale(final SharedPreferences prefs,
            final float defaultValue) {
        final float percentage = prefs.getFloat(
                DebugSettings.PREF_KEYBOARD_TEXT_SCALE, UNDEFINED_PREFERENCE_VALUE_FLOAT);
        return (percentage != UNDEFINED_PREFERENCE_VALUE_FLOAT) ? percentage : defaultValue;
    }
