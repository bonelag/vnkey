...
public final class DebugSettings {
    ...
    public static final String PREF_KEYBOARD_WIDTH_SCALE = "pref_keyboard_width_scale";
    public static final String PREF_KEYBOARD_TEXT_SCALE = "pref_keyboard_text_scale";
