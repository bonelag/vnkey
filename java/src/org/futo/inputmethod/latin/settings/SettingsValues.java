...
public class SettingsValues {
    ...
    public final boolean mAvoidAccentError;
    public final boolean mSmartBackspaceDeleteTone;
    ...
    public final float mKeyboardWidthScale;
    public final float mKeyboardTextScale;
    ...
    public SettingsValues(final Context context, final SharedPreferences prefs, final Resources res,
        ...
        mAvoidAccentError = prefs.getBoolean(Settings.PREF_AVOID_ACCENT_ERROR, true);
        mSmartBackspaceDeleteTone = prefs.getBoolean(Settings.PREF_SMART_BACKSPACE_DELETE_TONE, true);
        ...
        if (context instanceof org.futo.inputmethod.v2keyboard.KeyboardSizeStateProvider) {
            isLandscape = ((org.futo.inputmethod.v2keyboard.KeyboardSizeStateProvider) context).getCurrentSizeState() == org.futo.inputmethod.v2keyboard.KeyboardSizeSettingKind.Landscape;
        }
        float heightScale = prefs.getFloat(isLandscape ? "keyboard_height_scale_landscape" : DebugSettings.PREF_KEYBOARD_HEIGHT_SCALE, -1.0f);
        mKeyboardHeightScale = (heightScale != -1.0f) ? heightScale : DEFAULT_SIZE_SCALE;

        float widthScale = prefs.getFloat(isLandscape ? "keyboard_width_scale_landscape" : DebugSettings.PREF_KEYBOARD_WIDTH_SCALE, -1.0f);
        mKeyboardWidthScale = (widthScale != -1.0f) ? widthScale : DEFAULT_SIZE_SCALE;

        float textScale = prefs.getFloat(isLandscape ? "keyboard_text_scale_landscape" : DebugSettings.PREF_KEYBOARD_TEXT_SCALE, -1.0f);
        mKeyboardTextScale = (textScale != -1.0f) ? textScale : DEFAULT_SIZE_SCALE;
    ...
    public String dump() {
        ...
        sb.append("\n   mAvoidAccentError = ");
        sb.append("" + mAvoidAccentError);
        sb.append("\n   mSmartBackspaceDeleteTone = ");
        sb.append("" + mSmartBackspaceDeleteTone);
        sb.append("\n   mScreenMetrics = ");
        ...
        sb.append("\n   mKeyboardWidthScale = ");
        sb.append("" + mKeyboardWidthScale);
        sb.append("\n   mKeyboardTextScale = ");
        sb.append("" + mKeyboardTextScale);
        return sb.toString();
    }
}
