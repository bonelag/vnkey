...
import org.futo.inputmethod.latin.uix.ActionBarNoNewRow
...
val ActionsScreen = UserSettingsMenu(
    ...
    settings = listOf(
        ...
        UserSetting(
            name = R.string.action_settings_no_new_row,
            subtitle = R.string.action_settings_no_new_row_subtitle
        ) {
            SettingToggleDataStore(
                setting = ActionBarNoNewRow,
                title = stringResource(R.string.action_settings_no_new_row),
                subtitle = stringResource(R.string.action_settings_no_new_row_subtitle)
            )
        },
