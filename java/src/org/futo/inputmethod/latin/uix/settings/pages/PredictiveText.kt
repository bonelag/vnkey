...
val PredictiveTextMenu = UserSettingsMenu(
    ...
    settings = listOf(
        ...
        UserSetting(
            name = R.string.vi_autocorrect_level_title,
            searchTags = R.string.vi_autocorrect_level_tags
        ) {
            val setting = useDataStore(VIETNAMESE_AUTOCORRECT_LEVEL)
            SettingRadio(
                title = stringResource(R.string.vi_autocorrect_level_title),
                options = listOf(0, 1, 2),
                optionNames = listOf(
                    stringResource(R.string.vi_autocorrect_level_low),
                    stringResource(R.string.vi_autocorrect_level_balanced),
                    stringResource(R.string.vi_autocorrect_level_strict),
                ),
                setting = setting,
            )
        },
        ...
        userSettingToggleSharedPrefs(
            title = R.string.prediction_settings_avoid_accent_error,
            subtitle = R.string.prediction_settings_avoid_accent_error_summary,
            key = Settings.PREF_AVOID_ACCENT_ERROR,
            default = { true }
        )
    )
)